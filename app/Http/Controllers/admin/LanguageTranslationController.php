...
class LanguageTranslationController extends Controller
{
    ...
    public function index(Request $request, $language)
    {
        ...
        return view('admin.language.translation.languages.translations.index', compact('language', 'languages', 'groups', 'translations'));
    }

    public function create(Request $request, $language)
    {
        return view('admin.language.translation.languages.translations.create', compact('language'));
    }
