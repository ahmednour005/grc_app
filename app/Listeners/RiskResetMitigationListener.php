...
class RiskResetMitigationListener
{
     ...
     * Handle the event.
     *
     * @param  \App\Events\RiskResetMitigation  $event
     * @return void
     */
    public function handle(RiskResetMitigation $event)
    {
        // Get the action ID for Risk_Add
        $action1 = Action::where('name', 'Risk_Reset_Mitigations')->first();
