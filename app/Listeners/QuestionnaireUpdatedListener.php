...
class QuestionnaireUpdatedListener
{
     ...
     * Handle the event.
     *
     * @param  \App\Events\QuestionnaireUpdated  $event
     * @return void
     */
    public function handle(QuestionnaireUpdated $event)
    {
       // Get the action ID for Risk_Add
       $action1 = Action::where('name', 'Questionnaire_Update')->first();
