...
class RiskDeleteListener
{
     ...
     * Handle the event.
     *
     * @param  \App\Events\RiskDelete  $event
     * @return void
     */
    public function handle(RiskDelete $event)
    {
        // Get the action ID for Risk_Add
        $action1 = Action::where('name', 'Risk_Delete')->first();
