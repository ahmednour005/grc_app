...
class DepartementDeletedListener
{
     ...
     * Handle the event.
     *
     * @param  \App\Events\DepartementDeleted  $event
     * @return void
     */
    public function handle(DepartementDeleted $event)
    {
    
        // Get the action ID for Risk_Add
        $action1 = Action::where('name','Departement_Delete')->first();
