...
class ControlObjectivesMainUpdatedListener
{
     ...
     * Handle the event.
     *
     * @param  \App\Events\ControlObjectivesMainUpdated  $event
     * @return void
     */
    public function handle(ControlObjectivesMainUpdated $event)
    {
       
        // Get the action ID for Risk_Add
        $action1 = Action::where('name','Control_Objectives_Update')->first();
