...
class AssessmentCreatedListener
{
     ...
     * Handle the event.
     *
     * @param  \App\Events\AssessmentCreated  $event
     * @return void
     */
    public function handle(AssessmentCreated $event)
    {
        // getting the action id of event
       $action1 = Action::where('name', 'Assessment_Add')->first();
