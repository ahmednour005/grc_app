...
class RiskUpdateSubjectListener
{
     ...
     * Handle the event.
     *
     * @param  \App\Events\RiskUpdateSubject  $event
     * @return void
     */
    public function handle(RiskUpdateSubject $event)
    {
        // dd($event);

        // Get the action ID for Risk_Add
        $action1 = Action::where('name','Risk_Update_Subject')->first();
