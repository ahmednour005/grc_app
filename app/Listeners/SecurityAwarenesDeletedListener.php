...
class SecurityAwarenesDeletedListener
{
     ...
     * Handle the event.
     *
     * @param  \App\Events\SecurityAwarenesDeleted  $event
     * @return void
     */
    public function handle(SecurityAwarenesDeleted $event)
    {
        $action1 = Action::where('name', 'securityAwareness_delete')->first();
