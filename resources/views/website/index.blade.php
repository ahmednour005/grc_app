...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('website/css/simplegrid.css') }}">
    <link rel="stylesheet" href="{{ asset('website/css/icomoon.css') }}">
    <link rel="stylesheet" href="{{ asset('website/css/lightcase.css') }}">
    <link rel="stylesheet" href="{{ asset('website/js/owl-carousel/owl.carousel.css') }}" />
    <link rel="stylesheet" href="{{ asset('website/js/owl-carousel/owl.theme.css') }}" />
    <link rel="stylesheet" href="{{ asset('website/js/owl-carousel/owl.transitions.css') }}" />
                ...
                <div class="content">
                    ...
                    <nav class="navigation">
                        ...
                        <ul class="nav-container">
                            ...
                            @auth()
                            <li><a class="external" href="{{ route('admin.dashboard') }}">System</a></li>
                            @endauth
                            @guest
                            <li><a class="external" href="{{ route('login') }}">Login</a></li>
                            @endguest
                        </ul>
                    </nav>
                </div>
        ...
        <div class="grid grid-pad">
            <div class="col-1-1">
                <div class="content content-header">
                    ...
                    <p>
                        <img border="0" src="{{ asset('website/images/cybermode.png') }}" width="500" height="203" style="object-fit: contain"></p>
        ...
        <section class="grid grid-pad">
            ...
            <div class="portfolio-items">
                <div class="col-1-3 mix illustration">
                    <div class="content">
                        <div class="recent-work">
                            <img src="{{ asset('website/images/work/1-small.jpg') }}" alt="">
                            <div class="overlay">
                                <span>&#1589;&#1608;&#1585;&#1577;</span>
                ...
                <div class="col-1-3 mix illustration">
                    <div class="content">
                        <div class="recent-work">
                            <img src="{{ asset('website/images/work/2-small.jpg') }}" alt="">
                            <div class="overlay">
                                <span>&#1589;&#1608;&#1585;&#1577;</span>
                ...
                <div class="col-1-3 mix photography">
                    <div class="content">
                        <div class="recent-work">
                            <img src="{{ asset('website/images/work/8-small.jpg') }}" alt="">
                            <div class="overlay">
                                <span>&#1589;&#1608;&#1585;&#1577;</span>
                ...
                <div class="col-1-3 mix web-design">
                    <div class="content">
                        <div class="recent-work">
                            <img src="{{ asset('website/images/work/6-small.jpg') }}" alt="">
                            <div class="overlay">
                                <span>&#1589;&#1608;&#1585;&#1577;</span>
                ...
                <div class="col-1-3 mix web-design">
                    <div class="content">
                        <div class="recent-work">
                            <img src="{{ asset('website/images/work/3-small.jpg') }}" alt="">
                            <div class="overlay">
                                <span>&#1589;&#1608;&#1585;&#1577;</span>
                ...
                <div class="col-1-3 mix photography">
                    <div class="content">
                        <div class="recent-work">
                            <img src="{{ asset('website/images/work/7-small.jpg') }}" alt="">
                            <div class="overlay">
                                <span>&#1589;&#1608;&#1585;&#1577;</span>
                ...
                <div class="col-1-3 mix illustration">
                    <div class="content">
                        <div class="recent-work">
                            <img src="{{ asset('website/images/work/4-small.jpg') }}" alt="">
                            <div class="overlay">
                                <span>&#1589;&#1608;&#1585;&#1577;</span>
                ...
                <div class="col-1-3 mix illustration">
                    <div class="content">
                        <div class="recent-work">
                            <img src="{{ asset('website/images/work/9-small.jpg') }}" alt="">
                            <div class="overlay">
                                <span>&#1589;&#1608;&#1585;&#1577;</span>
            ...
            <div class="content">
                ...
                <div class="col-1-2">
                    <article class="post-wrap">
                        <div class="post-img">
                            <a href="#0"><img src="{{ asset('website/images/post/post-n1.jpg') }}" alt=""></a>
                        </div>
                        <div class="post">
                ...
                <div class="col-1-2">
                    <article class="post-wrap">
                        <div class="post-img">
                            <a href="#0"><img src="{{ asset('website/images/post/post-n2.jpg') }}" alt=""></a>
                        </div>
                        <div class="post">
