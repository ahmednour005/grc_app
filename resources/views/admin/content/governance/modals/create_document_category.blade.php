<div class="modal modal-slide-in sidebar-todo-modal fade" id="new-frame-modal">
    <div class="modal-dialog sidebar-lg">
        <div class="modal-content p-0">
            <form id="add_frame" class="add_frame todo-modal needs-validation" novalidate method="POST" action="{{route('admin.governance.category.store')}}">
                @csrf

                <div class="modal-header align-items-center mb-1">
                    <h5 class="modal-title">{{ __('governance.AddNewCategory') }}</h5>
