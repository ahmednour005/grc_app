...
(OrgChart._defaultConfig = function (t) {
                    ...
                    function (n) {
                        if (
                            ...
                            var h = a.getViewBox(),
                                d = n.viewBox;
                            o = { content: l, res: n };
                            OrgChart.events.publish("prerender", [a, o]),
                                (l = o.content);
    ...
    (OrgChart.prototype._get = function (t) {
        ...
        if (
            ...
            if (
                ((t = t.substring(r + "_balkan_id_".length)),
                (e = this.__get(t)))
            )
                return e;
        }
                        ...
                        function (t) {
                            ...
                            var r = a.value,
                                n = i.obj.element.querySelector(
                                    '[data-binding="' +
                                        OrgChart._escapeDoubleQuotes(a.value) +
                                        '"]'
                                );
        ...
        if (n.draggable) {
            ...
            var O = function (t, e) {
                    if (null != t) {
                        ...
                        for (
                            var r = OrgChart.getStParentNodes(o.getNode(d)),
                                i = 0;
                            i < r.length;
                            i++
                        ) {
        ...
        if (this.config.enableDragDrop) {
            ...
            var m = function (t, e) {
                ...
                b = function (e) {
                    ...
                    if (
                        !1 ===
                        OrgChart.events.publish("drop", [s, n.id, i.id, f])
                    )
                        return (
                            m(o, l),
                            h.removeChild(f),
        ...
        if (t) {
            if (t.hasAttribute("data-search-item-id")) {
                ...
                if (this.input.value != OrgChart.SEARCH_HELP_SYMBOL)
                    0 !=
                        OrgChart.events.publish("searchclick", [this.obj, e]) &&
                        this.obj.center(e);
                else
                    (this.input.value = e + " "),
    ...
    (OrgChart.searchUI.prototype._initSearchFields = function () {
        ...
        if (null == this.obj.config.searchFieldsAbbreviation) {
            ...
            this._searchFieldsAbbreviation =
                this.obj.config.searchFieldsAbbreviation;
    }),
    ...
    (OrgChart.searchUI.prototype._search = function () {
        ...
        if (
            ...
            t = `<table border="0" cellspacing="0" cellpadding="0">\n                        <tbody>\n                            ${(function () {
                for (
                    var t = "", i = 0;
                    i < e.lastSearch.length &&
                    !(i >= OrgChart.SEARCH_RESULT_LIMIT);
                    i++
                ) {
            ...
            i[a].addEventListener("click", function () {
                if (this.hasAttribute("data-search-item-id")) {
                    ...
                    if (e.input.value != OrgChart.SEARCH_HELP_SYMBOL) {
                        if (
                            !1 !==
                            OrgChart.events.publish("searchclick", [e.obj, t])
                        ) {
                            e.obj.center(
                                this.getAttribute("data-search-item-id")
                            );
                            var r = e.obj.element.querySelector(
                                '[data-selected="yes"]'
                            );
        ...
        if (
            (h != OrgChart.action.minimize || t.min
                ? h == OrgChart.action.maximize && !0 === t.min
                    ...
                    ? (t.min = !1)
                    : h == OrgChart.action.init &&
                      null != c &&
                      (t.min = c.min.has(t.id))
    ...
    (OrgChart.manager.__createNodes = function (t, e, r, i, a, n, o, l) {
        for (
            ...
            OrgChart.isNEU(g.ppid) || (f.ppid = g.ppid),
                ...
                null != r.orderBy &&
                    (f.order = OrgChart.manager._getOrderFieldValue(
                        g,
                        r.orderBy
                    )),
                (t[g.id] = f),
    ...
    (OrgChart.manager._createNodes = function (t) {
                ...
                if (c) {
                    ...
                    if (!u) {
                        if (!OrgChart.isNEU(c.pid))
                            (j = (O = l[c.pid]).childrenIds.indexOf(c.id)) >
                                -1 && O.childrenIds.splice(j, 1);
                        s.push(c);
                    }
                }
            }
        ...
        for (d = 0; d < I.length; d++) {
            ...
            for (x = 0; x < E.length; x++) {
                L[(D = l[E[x]]).id]
                    ? C.children.push(D)
                    : C.children.splice(0, 0, D);
                for (var H = 0; H < D.childrenIds.length; H++)
                    F.push(D.childrenIds[H]);
            }
            var R = [];
            for (x = 0; x < N.length; x++) {
                L[(D = l[N[x]]).id]
                    ? C.children.push(D)
                    : C.children.splice(0, 0, D);
                for (H = 0; H < D.childrenIds.length; H++)
                    R.push(D.childrenIds[H]);
            }
        ...
        for (d = 0; d < k.length; d++) {
            if (
                ...
                for (x = 0; x < C.subLevels; x++) {
                    ...
                    if (
                        (OrgChart.manager._initDinamicNode(z, C.lcn),
                        (O = C.parent))
                    )
                        (j = O.children.indexOf(C)) > -1 &&
                            (O.children.splice(j, 1),
                            O.children.splice(j, 0, z)),
                            z.children.push(C),
                            (z.parent = O),
                            (C.parent = z),
                            (l[z.id] = z);
                ...
                if ((at = r[O.lcn ? O.lcn : "base"]).layout > 0 || et)
                    if (
                        ...
                        for (d = rt.childrenIds.length - 1; d >= 0; d--) {
                            for (
                                D = l[rt.childrenIds[d]], x = 0;
                                x < O.children.length;
                                x++
                            )
                                O.children[x].id == D.id &&
                                    O.children.splice(x, 1);
                            if (
                                ((D.parent = null),
                                (D.layout = rt.layout),
    ...
    (OrgChart.manager._iterate2 = function (t, e, r, i, a, n, o, l, s, h) {
        if (OrgChart.manager._isVisible(t, r, i, a)) {
            ...
            if (
                ...
                if (
                    ((d = { x: (u = l[t.id]).x, y: u.y }), "all" == n.ids && u)
                ) {
                    d = { x: u.x, y: u.y };
    ...
    (OrgChart.manager._verticalAssistantLevelCountIterate = function (t, e, r) {
        ...
        for (var i = 0; i < t.children.length; i++)
            OrgChart.manager._verticalAssistantLevelCountIterate(
                t.children[i],
                e,
                r
            );
                    ...
                    if (
                        ...
                        for (; x; ) {
                            ...
                            OrgChart._intersects(x, f, t.config) &&
                                ((f = OrgChart._addPoint(x, s, t.config, f, d)),
                                (b = !0)),
                                (x = x.rightNeighbor);
                        }
                    }
                        ...
                        if (O.parent) {
                            (u = g.levelSeparation),
                                O.parent.layout &&
                                    (u = g.mixedHierarchyNodesSeparation);
                            var w =
                                t.manager.bordersByRootIdAndLevel[C.id][
                                    O.parent.sl
                                ];
                            switch (g.orientation) {
                                case OrgChart.orientation.top:
    ...
    OrgChart.events.on("redraw", function (t, e) {
        if (t.config.groupDottedLines.length) {
            for (
                var r = t.element.querySelectorAll(
            ...
            if (t.manager.action != OrgChart.action.move) {
                (OrgChart.miniMap._settings._scale = Math.min(
                    ...
                    (OrgChart.miniMap._settings._translateX =
                        -t.response.boundary.minX *
                            OrgChart.miniMap._settings._scale +
                        (OrgChart.miniMap.width -
                            (t.response.boundary.maxX -
                                t.response.boundary.minX) *
                                OrgChart.miniMap._settings._scale) /
                            2),
                    (OrgChart.miniMap._settings._translateY =
                        -t.response.boundary.minY *
                            OrgChart.miniMap._settings._scale +
                        (OrgChart.miniMap.height -
                            (t.response.boundary.maxY -
                                t.response.boundary.minY) *
                                OrgChart.miniMap._settings._scale) /
                            2);
                var r = t.getViewBox();
                    ...
                    i++,
                        a.includes(n.id) ||
                            (1 == i
                                ...
                                : 3 == i &&
                                  (r.fillStyle = OrgChart.miniMap.colors[2]),
                            r.beginPath(),
                            r.fillRect(n.x, n.y, n.w, n.h),
                            r.strokeRect(n.x, n.y, n.w, n.h),
                            a.push(n.id)),
    ...
    (OrgChart._search.search = function (t, e, r, i, a, n, o) {
        ...
        if (o && h.length > 1) {
            var d = h[0];
            o[d] &&
                ((r = [o[d]]), (h = (s = s.replace(d, "").trim()).split(" ")));
        }
        ...
        for (var c = {}, g = 0; g < t.length; g++)
            for (var p = t[g], u = 0; u < r.length; u++) {
                ...
                if (!OrgChart.isNEU(p[f])) {
                    ...
                    if (
                        null !=
                        (e = OrgChart._search.searchAndComputeScore(h, m, f, n))
                    ) {
                        var C = p.id;
                        if (c[C]) {
                    ...
                    if (
                        ...
                        for (
                            var e = t.target.getAttribute("data-filter-field"),
                                r =
                                    h.instance.element.querySelectorAll(
                                        "[data-filter-menu]"
                                    ),
                                i = 0;
                            i < r.length;
                        ...
                        var n = h.instance.element.querySelector(
                            "[data-filter-close]"
                        );
                        if (
                            ...
                            for (i = 0; i < g.length; i++)
                                g[i].addEventListener("change", function (t) {
                                    for (
                                        var e = t.target;
                                        e &&
                                        !e.hasAttribute("data-filter-menu");

                                    )
                                        e = e.parentNode;
                                    if (e) {
                                        var r =
                                            e.getAttribute("data-filter-menu");
